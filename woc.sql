...
USE WOC;
CREATE TABLE IF NOT EXISTS USER(id INT(6) AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(30) NOT NULL,phone VARCHAR(15) NOT NULL, email VARCHAR(50),type VARCHAR(10) NOT NULL,registration_date DATETIME NOT NULL,device_id VARCHAR(30),status VARCHAR(15),ratings DOUBLE,blood_group VARCHAR(5));
...
CREATE TABLE IF NOT EXISTS FEEDBACK(id INT(6) AUTO_INCREMENT PRIMARY KEY, trip_id INT(6) NOT NULL, user_id INT(6) NOT NULL,feedback_owner_id INT(6) NOT NULL,rating DOUBLE NOT NULL,comment VARCHAR(500));
CREATE TABLE IF NOT EXISTS PRICING(id INT(6) AUTO_INCREMENT PRIMARY KEY, city VARCHAR(20) NOT NULL,cost_per_km DOUBLE NOT NULL,cost_per_min DOUBLE NOT NULL,extra_charges DOUBLE NOT NULL);
