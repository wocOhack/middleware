...
CREATE TABLE IF NOT EXISTS RIDEREQUEST(id INT(6) AUTO_INCREMENT PRIMARY KEY, rider_id INT(6), driver_id INT(6),start_location VARCHAR(200),end_location VARCHAR(200));
​
​
...
ALTER TABLE RIDEREQUEST ADD CONSTRAINT FK_RideRequestRider FOREIGN KEY (rider_id) REFERENCES RIDER(id);
​
