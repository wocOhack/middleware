...
USE WOC;
CREATE TABLE IF NOT EXISTS USER(id INT(6) AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(30) NOT NULL,phone VARCHAR(15) NOT NULL, email VARCHAR(50),type VARCHAR(10) NOT NULL,registration_date DATETIME NOT NULL,device_id VARCHAR(30),status VARCHAR(15),ratings DOUBLE(5),blood_group VARCHAR(5));
CREATE TABLE IF NOT EXISTS RIDER(id INT(6) AUTO_INCREMENT PRIMARY KEY, pin INT(6),is_challenged BOOL NOT NULL,is_verified BOOL,verification_date DATETIME,verified_date DATETIME,proof_of_challenge VARCHAR(200), user_id INT(6),deviceID VARCHAR(300),location VARCHAR(200));
...
CREATE TABLE IF NOT EXISTS VEHICLE(id INT(6) AUTO_INCREMENT PRIMARY KEY, user_id INT(6) NOT NULL,vehicle_number VARCHAR(20) NOT NULL,insurance_doc VARCHAR(200) NOT NULL,insurance_number VARCHAR(200) NOT NULL,vehicle_model VARCHAR(20),vehicle_type VARCHAR(20),vehicle_doc VARCHAR(200),is_verified BOOL,verifiedby VARCHAR(50),verification_date DATETIME);
CREATE TABLE IF NOT EXISTS TRIP(id INT(6) AUTO_INCREMENT PRIMARY KEY, driver_id INT(6) NOT NULL,rider_id INT(6) NOT NULL,start_location VARCHAR(200),end_location VARCHAR(200), trip_start_time DATETIME, trip_end_time DATETIME, duration INT(10), distance DOUBLE, cost DOUBLE, status VARCHAR(2), cancelled_by INT(6), created_time DATETIME,updated_time DATETIME);
CREATE TABLE IF NOT EXISTS FEEDBACK(id INT(6) AUTO_INCREMENT PRIMARY KEY, trip_id INT(6) NOT NULL, user_id INT(6) NOT NULL,feedback_owner_id INT(6) NOT NULL,rating DOUBLE(2) NOT NULL,comment VARCHAR(500));
CREATE TABLE IF NOT EXISTS PRICING(id INT(6) AUTO_INCREMENT PRIMARY KEY, city VARCHAR(20) NOT NULL,cost_per_km DOUBLE(4) NOT NULL,cost_per_min DOUBLE(4) NOT NULL,extra_charges DOUBLE(6) NOT NULL);
...
CREATE TABLE IF NOT EXISTS RIDEREQUEST(id INT(6) AUTO_INCREMENT PRIMARY KEY, rider_id INT(6), driver_id INT(6),start_location VARCHAR(200),end_location VARCHAR(200),start_lat DOUBLE,end_lat DOUBLE,start_long DOUBLE,end_long DOUBLE,notified_drivers VARCHAR(300));
